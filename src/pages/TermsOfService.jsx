            ...
            <div className="terms-section">
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 lg:p-12 border border-gray-200 shadow-lg">
                ...
                <ul className="space-y-4 text-lg lg:text-xl text-gray-700">
                  ...
                  <li className="flex items-start gap-3">
                    <span className="text-[#D3FD50] font-bold mt-1">•</span>
                    <span>To transmit, or procure the sending of, any advertising or promotional material</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#D3FD50] font-bold mt-1">•</span>
                    <span>To impersonate or attempt to impersonate the company or any employee, another user, or any other person or entity</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#D3FD50] font-bold mt-1">•</span>
